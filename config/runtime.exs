...
# #
# #     PHX_SERVER=true bin/rbac_app start
# #
# # Alternatively, you can use `mix phx.gen.release` to generate a `bin/server`
# # script that automatically sets the env var above.
# if System.get_env("PHX_SERVER") do
#   config :rbac_app, RbacAppWeb.Endpoint, server: true
# end
...
#   config :rbac_app, :dns_cluster_query, System.get_env("DNS_CLUSTER_QUERY")
...
#   #
#   #     config :rbac_app, RbacApp.Mailer,
