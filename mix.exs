defmodule RbacApp.MixProject do
  use Mix.Project
  ...
  defp aliases do
    [
      ...
      "assets.build": ["compile", "tailwind rbac_app", "esbuild rbac_app"],
      "assets.deploy": [
        "tailwind rbac_app --minify",
        "esbuild rbac_app --minify",
        "phx.digest"
      ],
